...
export ALR_TOOLS="$HOME/.local/share/alire/toolchains"
export PATH="$ALR_TOOLS/gnat_native_15.2.1_4640d4b3/bin:$ALR_TOOLS/gprbuild_26.0.1_e3f27f25/bin:$PATH"
...
alias tarch='vim /mnt/aliqyan_hdd/Vicharak/repos/Quantpnr_RisikAnna/arch_exp/tiles/arch_oph_337x642_b33_d10.xml'
...
alias z='nohup ~/Downloads/softwares/zennotes/ZenNotes-2.3.0-linux-x86_64.AppImage --appimage-extract-and-run & > /dev/null'
